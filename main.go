...
func (w Walking) Calories() float64 {
	...
	squareSpeed := math.Pow(speedInMsec, 2)
	heightInM := w.Height / CmInM
	return (CaloriesWeightMultiplier*w.Weight + (squareSpeed/heightInM)*CaloriesSpeedHeightMultiplier*w.Weight) * float64(w.Duration.Hours()) * MinInHours
